...
const CardTech = () => {
  ...
  const iconSize = isMobile ? 15 : isTablet ? 30 : 35;

  return (
    <div className="relative flex h-[12em] w-[12em] items-center justify-center gap-2 lg:gap-12 rounded-3xl bg-black p-2 pt-10 text-center shadow-2xl shadow-black sm:h-[16em] sm:w-[18em] md:h-[18em] md:w-full xl:h-[18em] xl:w-[30em]">
      <span className="absolute -top-0 left-1/2 -translate-x-2/4">
        <h1 className={`${unica.className} text-3xl text-[#98AAB9]`}>
          Tecnologias
        </h1>
      </span>
